...
### The following code gives an implementation of the
### "archaeology example" in WIKIPEDIA'S entry for 
### "Bayesian inference" 
###
...
#sample take  u = 13.5 add 20 samples at a time

set.seed(123)

# make room for 11 plots
...
# sample from density to get the posterior density of the site data
