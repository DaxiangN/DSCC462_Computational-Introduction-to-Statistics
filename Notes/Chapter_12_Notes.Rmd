...
My understanding: it depends on which one you picked up for determining the W. In the example problem in the slides, H1 is about group 1 has less values, and W turns out to be W1, therefore p-value = Pr(z < 0). 
